...
>
> 수집 주기: 매주 월요일 오전 5시 KST | 마지막 업데이트: 2026-05-18

---

## 📈 금융 & 경제

### 1. OpenBB-finance/OpenBB (⭐⭐ 67.7k) ★
...
### 5. TauricResearch/TradingAgents (⭐⭐ 76.5k) ★
...
### 8. AI4Finance-Foundation/FinGPT (⭐⭐ 20.0k) ★
...
### 12. LearningCircuit/local-deep-research (⭐⭐ 7.1k) ★
...
### 19. cocoindex-io/cocoindex (⭐⭐ 9.5k) ★
...
### 21. addyosmani/agent-skills (⭐⭐ 42.8k)
...
### 23. Imbad0202/academic-research-skills (⭐⭐ 9.2k)
...
### 24. Hmbown/DeepSeek-TUI (⭐⭐ 31.2k)
**링크:** https://github.com/Hmbown/DeepSeek-TUI
**설명:** DeepSeek 모델용 터미널 코딩 에이전트 — 로컬 워크스페이스 편집과 자동 모드
**핵심:** Rust 바이너리로 배포되는 DeepSeek V4 전용 TUI 코딩 에이전트. `deepseek` 명령 하나로 추론 블록 스트리밍, 승인 게이트가 있는 로컬 워크스페이스 편집, 턴당 모델/사고 수준 선택 자동 모드 제공. npm/Cargo/Homebrew/Docker 모두 지원. 31.2k ⭐, 1,386+ 커밋으로 매우 활발한 개발 중.
**우리 활용:** DeepSeek V4 기반 로컬 코딩 에이전트가 필요할 때 참고. 특히 Rust 기반 경량 설계와 자동 모드 아키텍처가 Hermes의 에이전트 시스템과 시너지 가능.

---

## 🧠 철학 & 인문

### 25. hackerkid/Mind-Expanding-Books (⭐⭐ 13.7k)
