...
>
> 수집 주기: 매주 월요일 오전 5시 KST | 마지막 업데이트: 2026-05-11

---

## 📈 금융 & 경제

### 1. OpenBB-finance/OpenBB (⭐⭐ 67.3k) ★
...
### 5. TauricResearch/TradingAgents (⭐⭐ 73.1k) ★
**링크:** https://github.com/TauricResearch/TradingAgents
**설명:** 멀티 에이전트 LLM 트레이딩 프레임워크 — AI 에이전트들이 협력하여 트레이딩 결정
**핵심:** 여러 LLM 기반 에이전트(분석관, 리스크관리자, 전략가 등)가 협력하여 금융 거래를 수행. GitHub 전 분야 트렌딩 지속 1위 — 주간 +11,541 ⭐. Python 기반.
...
### 18. cocoindex-io/cocoindex (⭐⭐ 9.5k) ★
...
### 20. addyosmani/agent-skills (⭐⭐ 38.3k)
...
### 21. hackerkid/Mind-Expanding-Books (⭐⭐ 13.7k)
